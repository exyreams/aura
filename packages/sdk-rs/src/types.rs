...
pub use aura_core::{
    ...
    DWalletCurve, DWalletReference, EmergencyMultisig, ExecutePendingVectorFheArgs,
    ExecutionReceipt, GrantOperatorRoleArgs, InitExposureGroupArgs, InitExternalLivenessArgs,
    OverrideProposal, PendingDecryptionRequest, PendingSignatureRequest, PendingTransaction,
    PolicyConfigRecord, PolicyStateRecord, ProposalStatus, ProposeBatchArgs,
    ProposeConfidentialTransactionArgs, ProposeTransactionArgs, ProtocolDeployment, ProtocolFees,
    ProtocolFeesRecord, RefreshExternalLivenessArgs, RegisterDwalletArgs, SetScopedPauseArgs,
    SignatureScheme, SimulatePolicyArgs, SwarmConfigRecord, TreasuryAccount,

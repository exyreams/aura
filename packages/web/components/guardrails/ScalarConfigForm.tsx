    ...
    <>
      <Card className="mb-4 p-6" hover={false}>
        ...
        <div className="flex items-center gap-4 p-4 bg-white/2 border border-white/5 rounded-lg mb-8 group">
          <div className="size-10 bg-white/5 rounded flex items-center justify-center shrink-0 border border-white/5">
            <Lock className="size-5 text-(--text-muted) group-hover:text-(--text-main) transition-colors" />
          </div>
          <div>

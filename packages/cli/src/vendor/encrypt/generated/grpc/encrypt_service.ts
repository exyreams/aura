...
export const EncryptedInput: MessageFns<EncryptedInput> = {
	...
	create<I extends Exact<DeepPartial<EncryptedInput>, I>>(
		base?: I,
	): EncryptedInput {
		return EncryptedInput.fromPartial(base ?? ({} as any));
	},
	fromPartial<I extends Exact<DeepPartial<EncryptedInput>, I>>(
		object: I,
	): EncryptedInput {
		const message = createBaseEncryptedInput();
...
export const CreateInputRequest: MessageFns<CreateInputRequest> = {
	...
	fromJSON(object: any): CreateInputRequest {
		return {
			...
			inputs: globalThis.Array.isArray(object?.inputs)
				? object.inputs.map((e: any) => EncryptedInput.fromJSON(e))
				: [],
			proof: isSet(object.proof)
				? Buffer.from(bytesFromBase64(object.proof))
				: Buffer.alloc(0),
			authorized: isSet(object.authorized)
				? Buffer.from(bytesFromBase64(object.authorized))
				: Buffer.alloc(0),
	...
	toJSON(message: CreateInputRequest): unknown {
		...
		if (message.networkEncryptionPublicKey.length !== 0) {
			obj.networkEncryptionPublicKey = base64FromBytes(
				message.networkEncryptionPublicKey,
			);
		}
		return obj;
	},

	create<I extends Exact<DeepPartial<CreateInputRequest>, I>>(
		base?: I,
	): CreateInputRequest {
		return CreateInputRequest.fromPartial(base ?? ({} as any));
	},
	fromPartial<I extends Exact<DeepPartial<CreateInputRequest>, I>>(
		object: I,
	): CreateInputRequest {
		const message = createBaseCreateInputRequest();
		message.chain = object.chain ?? 0;
		message.inputs =
			object.inputs?.map((e) => EncryptedInput.fromPartial(e)) || [];
		message.proof = object.proof ?? Buffer.alloc(0);
		message.authorized = object.authorized ?? Buffer.alloc(0);
		message.networkEncryptionPublicKey =
			object.networkEncryptionPublicKey ?? Buffer.alloc(0);
		return message;
	},
};
...
export const CreateInputResponse: MessageFns<CreateInputResponse> = {
	...
	fromJSON(object: any): CreateInputResponse {
		return {
			ciphertextIdentifiers: globalThis.Array.isArray(
				object?.ciphertextIdentifiers,
			)
				? object.ciphertextIdentifiers.map((e: any) =>
						Buffer.from(bytesFromBase64(e)),
					)
				: globalThis.Array.isArray(object?.ciphertext_identifiers)
					? object.ciphertext_identifiers.map((e: any) =>
							Buffer.from(bytesFromBase64(e)),
						)
					: [],
		};
	...
	toJSON(message: CreateInputResponse): unknown {
		...
		if (message.ciphertextIdentifiers?.length) {
			obj.ciphertextIdentifiers = message.ciphertextIdentifiers.map((e) =>
				base64FromBytes(e),
			);
		}
		return obj;
	...
	create<I extends Exact<DeepPartial<CreateInputResponse>, I>>(
		base?: I,
	): CreateInputResponse {
		return CreateInputResponse.fromPartial(base ?? ({} as any));
	},
	fromPartial<I extends Exact<DeepPartial<CreateInputResponse>, I>>(
		object: I,
	): CreateInputResponse {
		const message = createBaseCreateInputResponse();
		message.ciphertextIdentifiers =
			object.ciphertextIdentifiers?.map((e) => e) || [];
		return message;
	},
};
...
export const ReadCiphertextRequest: MessageFns<ReadCiphertextRequest> = {
	...
	fromJSON(object: any): ReadCiphertextRequest {
		return {
			...
			signer: isSet(object.signer)
				? Buffer.from(bytesFromBase64(object.signer))
				: Buffer.alloc(0),
		};
	},
	...
	create<I extends Exact<DeepPartial<ReadCiphertextRequest>, I>>(
		base?: I,
	): ReadCiphertextRequest {
		return ReadCiphertextRequest.fromPartial(base ?? ({} as any));
	},
	fromPartial<I extends Exact<DeepPartial<ReadCiphertextRequest>, I>>(
		object: I,
	): ReadCiphertextRequest {
		const message = createBaseReadCiphertextRequest();
...
export const ReadCiphertextResponse: MessageFns<ReadCiphertextResponse> = {
	...
	create<I extends Exact<DeepPartial<ReadCiphertextResponse>, I>>(
		base?: I,
	): ReadCiphertextResponse {
		return ReadCiphertextResponse.fromPartial(base ?? ({} as any));
	},
	fromPartial<I extends Exact<DeepPartial<ReadCiphertextResponse>, I>>(
		object: I,
	): ReadCiphertextResponse {
		const message = createBaseReadCiphertextResponse();
...
export const EncryptServiceService = {
	...
	createInput: {
		...
		requestSerialize: (value: CreateInputRequest): Buffer =>
			Buffer.from(CreateInputRequest.encode(value).finish()),
		requestDeserialize: (value: Buffer): CreateInputRequest =>
			CreateInputRequest.decode(value),
		responseSerialize: (value: CreateInputResponse): Buffer =>
			Buffer.from(CreateInputResponse.encode(value).finish()),
		responseDeserialize: (value: Buffer): CreateInputResponse =>
			CreateInputResponse.decode(value),
	},
	/**
	...
	readCiphertext: {
		...
		requestDeserialize: (value: Buffer): ReadCiphertextRequest =>
			ReadCiphertextRequest.decode(value),
		responseSerialize: (value: ReadCiphertextResponse): Buffer =>
			Buffer.from(ReadCiphertextResponse.encode(value).finish()),
		responseDeserialize: (value: Buffer): ReadCiphertextResponse =>
			ReadCiphertextResponse.decode(value),
	},
} as const;
...
export interface EncryptServiceServer extends UntypedServiceImplementation {
	 ...
	 * are rejected.
	 */
	readCiphertext: handleUnaryCall<
		ReadCiphertextRequest,
		ReadCiphertextResponse
	>;
}

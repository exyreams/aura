...
| Guide | Contents |
|---|---|
| [01 — Getting Started](./01-getting-started.md) | Installation, setup, global flags, JSON output, dry-run |
| [02 — Treasury](./02-treasury.md) | create, show, list, propose, pause, cancel |
| [03 — dWallet](./03-dwallet.md) | register (basic + live signing), list |

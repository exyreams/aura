...
| 6137 | `GuardrailEpochMismatch` | A decryption request was bound to an older confidential guardrail epoch. |
| 6138 | `ConfidentialGuardrailsDisabled` | Confidential guardrails are disabled (falls back to public policy). |
| 6139 | `GuardrailRotationRequired` | Confidential guardrails must be rotated before use. |

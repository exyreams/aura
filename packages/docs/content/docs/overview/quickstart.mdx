...
<Cards>
  <Card title="Confidential Guardrails" description="Add FHE-encrypted spend limits to your treasury." href="/docs/overview/confidential-guardrails" />
  <Card title="Key Concepts" description="Treasury, proposal lifecycle, PDA seeds, and more." href="/docs/overview/concepts" />
  <Card title="TypeScript SDK" description="Full AuraClient and Aura API reference." href="/docs/sdk-ts" />
  <Card title="CLI Tool" description="Manage treasuries from the terminal." href="/docs/cli" />
</Cards>

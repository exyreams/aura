...
<Cards>
  <Card title="Confidential Guardrails" description="FHE evaluation for per_tx and daily limits." href="/docs/overview/confidential-guardrails" />
  <Card title="Architecture" description="How aura-policy is called from aura-core." href="/docs/overview/architecture" />
  <Card title="Quick Start" description="Create a treasury with a full PolicyConfig." href="/docs/overview/quickstart" />
</Cards>

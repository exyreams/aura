...
<Cards>
  <Card title="Confidential Guardrails" description="FHE evaluation that gates co-sign requests." href="/docs/overview/confidential-guardrails" />
  <Card title="Policy Engine" description="Rules evaluated before execution is allowed." href="/docs/overview/policy-engine" />
  <Card title="dWallet Instructions (SDK)" description="register_dwallet, execute_pending, finalize_execution." href="/docs/sdk-ts/instructions/dwallet" />
</Cards>

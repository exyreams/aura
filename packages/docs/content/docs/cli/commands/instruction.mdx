...
```bash $ aura instruction list AURA :: Instruction Surface
...
<small>Example output:</small>
```bash $ aura instruction schema AURA :: proposeTransaction
...
<small>Example output:</small>
``` $ aura instruction send ✓ Instruction sent: 2pVk…Hn6Z ```

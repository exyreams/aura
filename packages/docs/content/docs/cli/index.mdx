...
# Submit a vector confidential proposal
aura confidential propose-vector --agent-id agent-1 --amount 250 --chain ethereum --recipient 0x...
...
<Cards>
  <Card title="Configuration" description="Config file, environment variables, and resolution order." href="/docs/cli/configuration" />
  <Card title="Commands" description="Full command reference for all groups." href="/docs/cli/commands" />
</Cards>

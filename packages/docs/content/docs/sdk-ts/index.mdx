...
Current published package: `@aura-protocol/sdk-ts@0.2.12`.
...
- 70 current `aura-core` instructions, including `executePendingVectorFhe`
...
```bash
npm pack @aura-protocol/sdk-ts@0.2.12 --json
npm view @aura-protocol/sdk-ts@0.2.12 readmeFilename readme
```
...
<Cards>
  ...
  <Card title="Instruction Surface" description="All 13 instruction domains and 70 instructions exposed by the SDK." href="/docs/sdk-ts/instructions" />
  <Card title="Confidential Flow" description="Scalar/vector guardrails, Encrypt CPI, and policy decryption." href="/docs/sdk-ts/instructions/confidential" />

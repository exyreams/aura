...
<Cards>
  <Card title="Proposals" description="Pass addressList in proposal accounts to enforce lists." href="/docs/sdk-ts/instructions/proposals" />
  <Card title="Operations" description="Operator roles for delegated list management." href="/docs/sdk-ts/instructions/operations" />
</Cards>

...
| All 70 instructions | Subset (common ops) | Full surface |
| Best for | Apps, agents, scripts | Advanced / batching |

For anything not covered by `Aura`, drop down to `aura.lowLevel`.

<Cards>
  <Card title="AuraClient Overview" description="Full low-level API with all 70 instructions." href="/docs/sdk-ts/client/overview" />

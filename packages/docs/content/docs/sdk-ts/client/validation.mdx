...
<Cards>
  <Card title="Errors" description="Full list of program error codes and how to catch them." href="/docs/sdk-ts/client/errors" />
  <Card title="Examples" description="End-to-end patterns using validation before send." href="/docs/sdk-ts/examples" />
  <Card title="Proposals" description="Propose transactions once inputs are validated." href="/docs/sdk-ts/instructions/proposals" />
</Cards>

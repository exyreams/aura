...
single transaction, and exposes the complete 50+ instruction surface.
...
<Cards>
  ...
  <Card title="Program API" description="All 50+ instruction methods by domain." href="/docs/sdk-ts/instructions" />
</Cards>

...
<Cards>
  <Card title="Aura (High-Level)" description="Simplified API with auto timestamps and plain numbers." href="/docs/sdk-ts/aura" />
  <Card title="Client Reference" description="Full AuraClient API — constructor, accounts, PDAs." href="/docs/sdk-ts/client/overview" />
  <Card title="Program API" description="All 67 instructions by domain." href="/docs/sdk-ts/instructions" />
  <Card title="Validation" description="Check policy rules before sending." href="/docs/sdk-ts/client/validation" />
</Cards>

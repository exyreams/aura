...
<Cards>
  <Card title="Types" description="Domain and record types." href="/docs/sdk-rs/client/types" />
  <Card title="AuraClient" description="Full client API." href="/docs/sdk-rs/client/overview" />

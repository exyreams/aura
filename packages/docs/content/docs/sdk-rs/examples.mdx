...
<Cards>
  <Card title="AuraClient" description="Full client API reference." href="/docs/sdk-rs/client/overview" />
  <Card title="Program API" description="All Rust instruction builders by domain." href="/docs/sdk-rs/instructions" />
  <Card title="Types" description="Domain and record type reference." href="/docs/sdk-rs/client/types" />
</Cards>

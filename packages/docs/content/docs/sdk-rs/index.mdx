...
<Cards>
  <Card title="AuraClient" description="Create clients, fetch accounts, and send transactions." href="/docs/sdk-rs/client/overview" />
  <Card title="Program API" description="Rust builders for all AURA instructions." href="/docs/sdk-rs/instructions" />

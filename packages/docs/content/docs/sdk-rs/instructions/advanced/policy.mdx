...
<Cards>
  <Card title="Budget" description="Budget envelopes, exposure groups, and approval ladders." href="/docs/sdk-rs/instructions/budget" />
  <Card title="Execution" description="Drive proposals through policy and dWallet signing." href="/docs/sdk-rs/instructions/execution" />
</Cards>

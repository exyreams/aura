...
<Cards>
  <Card title="Proposals" description="Pass address_list in proposal accounts to enforce lists." href="/docs/sdk-rs/instructions/proposals" />
  <Card title="Operations" description="Operator roles for delegated list management." href="/docs/sdk-rs/instructions/operations" />
</Cards>

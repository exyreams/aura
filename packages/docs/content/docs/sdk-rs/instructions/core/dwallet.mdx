...
<Cards>
  <Card title="Execution" description="Drive the proposal → sign → finalize flow." href="/docs/sdk-rs/instructions/execution" />
  <Card title="Confidential" description="FHE-encrypted guardrails for private spending limits." href="/docs/sdk-rs/instructions/confidential" />
</Cards>

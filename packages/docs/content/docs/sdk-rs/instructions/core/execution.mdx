...
<Cards>
  <Card title="Proposals" description="Create the proposal that feeds into this flow." href="/docs/sdk-rs/instructions/proposals" />
  <Card title="dWallet" description="Register the dWallet required for co-signing." href="/docs/sdk-rs/instructions/dwallet" />
</Cards>

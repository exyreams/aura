...
<Cards>
  <Card title="Policy" description="simulate_policy for single-proposal pre-flight checks." href="/sdk-rs/instructions/policy" />
  <Card title="Proposals" description="Submit individual proposals after batch validation." href="/sdk-rs/instructions/proposals" />
</Cards>

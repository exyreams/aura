...
A swarm pool is a shared spending counter across multiple agent treasuries. Use `configure_swarm` (in [Governance](/sdk-rs/instructions/governance)) to attach a treasury to a swarm. Use the instructions below to create and join the pool account itself.
...
<Cards>
  <Card title="Governance" description="configure_swarm and other treasury-level governance." href="/sdk-rs/instructions/governance" />

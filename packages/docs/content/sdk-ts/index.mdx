...
<Cards>
  <Card title="AuraClient" description="Full client API — account fetches, PDA derivation, and transaction helpers." href="/sdk-ts/client" />
  <Card title="Instruction Surface" description="All 13 instruction domains and 67 instructions exposed by the SDK." href="/sdk-ts/instructions" />
  <Card title="Confidential Flow" description="Scalar guardrails, Encrypt CPI, and policy decryption." href="/sdk-ts/instructions/confidential" />
  <Card title="Governance" description="Multisig overrides, rotations, config changes, and shutdown." href="/sdk-ts/instructions/governance" />
</Cards>

...
<Cards>
  <Card title="Validation" description="Client-side input validation before sending." href="/sdk-ts/client/validation" />
  <Card title="Events" description="Parse events from transaction logs." href="/sdk-ts/client/events" />
  <Card title="Examples" description="Full error handling patterns in context." href="/sdk-ts/examples" />
</Cards>

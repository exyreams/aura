...
<Cards>
  <Card title="Confidential Setup" description="Configure scalar FHE guardrails before confidential proposals." href="/sdk-ts/instructions/confidential" />
  <Card title="Execution" description="Drive the proposal through decryption, dWallet signing, and finalization." href="/sdk-ts/instructions/execution" />
</Cards>

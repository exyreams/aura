...
<Cards>
  <Card title="Execution" description="Drive the proposal → sign → finalize flow." href="/sdk-ts/instructions/execution" />
  <Card title="Confidential" description="FHE-encrypted guardrails for private spending limits." href="/sdk-ts/instructions/confidential" />
</Cards>

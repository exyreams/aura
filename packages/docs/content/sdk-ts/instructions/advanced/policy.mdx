...
<Cards>
  <Card title="Budget" description="Budget envelopes, exposure groups, and approval ladders." href="/sdk-ts/instructions/budget" />
  <Card title="Execution" description="Drive proposals through policy and dWallet signing." href="/sdk-ts/instructions/execution" />
</Cards>

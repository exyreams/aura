...
<Cards>
  <Card title="Policy" description="simulatePolicy for single-proposal pre-flight checks." href="/sdk-ts/instructions/policy" />
  <Card title="Proposals" description="Submit individual proposals after batch validation." href="/sdk-ts/instructions/proposals" />
</Cards>

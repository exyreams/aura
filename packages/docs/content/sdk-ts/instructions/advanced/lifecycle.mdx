...
<Cards>
  <Card title="Operations" description="Operator roles, liveness, health scores, and snapshots." href="/sdk-ts/instructions/operations" />
  <Card title="Governance" description="Emergency shutdown and authority rotation." href="/sdk-ts/instructions/governance" />
</Cards>

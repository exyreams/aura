...
<Cards>
  <Card title="Governance" description="configureSwarm and other treasury-level governance." href="/sdk-ts/instructions/governance" />
  <Card title="Budget" description="Budget envelopes and exposure groups." href="/sdk-ts/instructions/budget" />
</Cards>

...
<Callout type="info">
  For the Ika-dependent flows (`executePending`, `finalizeExecution`,
  confidential proposals, dWallet break-glass), see the Rust smoke binaries in
  `smoke/aura-devnet/`, which exercise the full CPI paths against live devnet.
</Callout>

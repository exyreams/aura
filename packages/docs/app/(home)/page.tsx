    ...
    <div className="relative min-h-screen bg-(--bg) text-(--text-main) overflow-x-hidden">
      ...
      <section className="relative z-10 px-6 md:px-[4vw] pb-24">
        <div className="max-w-6xl mx-auto">
          <div className="mb-12">
            <p className="font-mono text-[0.7rem] uppercase tracking-widest text-(--primary) mb-3">
              What it does
            </p>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-px bg-(--border)">
            {features.map((f) => (
              ...
              >
                ...
                <h3 className="font-semibold text-(--text-main) mb-2 text-sm tracking-wide">
                  {f.title}
                </h3>
      ...
      <section className="relative z-10 px-6 md:px-[4vw] pb-32">
        <div className="max-w-6xl mx-auto border border-(--border) p-8 md:p-12">
          <p className="font-mono text-[0.7rem] uppercase tracking-widest text-(--primary) mb-6">
            Devnet deployment
          </p>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {[
              ...
              {
                label: "Ika Encrypt",
                value: "4ebfzWdKnrnGseuQpezXdG8yCdHqwQ1SSBHD3bWArND8",
              },
              {
                label: "Ika dWallet",
              ...
              <div key={item.label}>
                <p className="font-mono text-[0.65rem] uppercase tracking-widest text-(--text-muted) mb-2">
                  {item.label}
                </p>
